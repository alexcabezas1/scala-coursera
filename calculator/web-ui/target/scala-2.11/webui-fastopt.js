...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__sci_List__D = (function(expr, references, computed) {
  _eval: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var a = x3.a$2;
      var b = x3.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__sci_List__D(a, references, $m_sci_Nil$()) + this.eval__Lcalculator_Expr__sci_Map__sci_List__D(b, references, $m_sci_Nil$()))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x4 = $as_Lcalculator_Minus(x1);
      var a$2 = x4.a$2;
      var b$2 = x4.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__sci_List__D(a$2, references, $m_sci_Nil$()) - this.eval__Lcalculator_Expr__sci_Map__sci_List__D(b$2, references, $m_sci_Nil$()))
    } else if ($is_Lcalculator_Times(x1)) {
      var x5 = $as_Lcalculator_Times(x1);
      var a$3 = x5.a$2;
      var b$3 = x5.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__sci_List__D(a$3, references, $m_sci_Nil$()) * this.eval__Lcalculator_Expr__sci_Map__sci_List__D(b$3, references, $m_sci_Nil$()))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x6 = $as_Lcalculator_Divide(x1);
      var a$4 = x6.a$2;
      var b$4 = x6.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__sci_List__D(a$4, references, $m_sci_Nil$()) / this.eval__Lcalculator_Expr__sci_Map__sci_List__D(b$4, references, $m_sci_Nil$()))
      ...
      if ($s_sc_LinearSeqOptimized$class__contains__sc_LinearSeqOptimized__O__Z(this$1, name)) {
        ...
        var this$2 = computed;
        var temp$computed = new $c_sci_$colon$colon().init___O__sci_List(name, this$2);
        expr = temp$expr;
        computed = temp$computed;
        continue _eval
      }
    } else {
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      var nowdelta = $uD(delta$1.apply__O());
      if ((nowdelta > 0.0)) {
        var sqrt_delta = $uD($g["Math"]["sqrt"](nowdelta));
        var array = [(((-$uD(b$2.apply__O())) + sqrt_delta) / (2 * $uD(a$2.apply__O()))), (((-$uD(b$2.apply__O())) - sqrt_delta) / (2 * $uD(a$2.apply__O())))];
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var cnt = $uI(remainingCharsCount$1.apply__O());
      return ((cnt >= 0) ? ((cnt <= 14) ? "orange" : "green") : "red")
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T2__T2 = (function(x$1) {
  if ((x$1 !== null)) {
    ...
    var s = $as_Lcalculator_Signal(x$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, s$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__sci_List__D($as_Lcalculator_Expr(s$1.apply__O()), arg$outer.namedExpressions$1$f, $m_sci_Nil$())
      })
    })(this, s));
